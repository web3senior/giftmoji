...
"[project]/node_modules/json-rpc-2.0/dist/models.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
var isJSONRPCRequest = function(payload) {
    return payload.jsonrpc === exports.JSONRPC && payload.method !== undefined && payload.result === undefined && payload.error === undefined;
};
...
var isJSONRPCResponse = function(payload) {
    return payload.jsonrpc === exports.JSONRPC && payload.id !== undefined && (payload.result !== undefined || payload.error !== undefined);
};
...
"[project]/node_modules/json-rpc-2.0/dist/internal.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/json-rpc-2.0/dist/client.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
var models_1 = __turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/models.js [app-ssr] (ecmascript)");
var internal_1 = __turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/internal.js [app-ssr] (ecmascript)");
var JSONRPCClient = function() {
                ...
                switch(_a.label){
                    ...
                    case 1:
                        ...
                        if (response.result !== undefined && !response.error) {
                            ...
                            return [
                                2 /*return*/ ,
                                Promise.reject(new models_1.JSONRPCErrorException(response.error.message, response.error.code, response.error.data))
                            ];
                        } else {
                            return [
                                2 /*return*/ ,
    ...
    JSONRPCClient.prototype.notify = function(method, params, clientParams) {
        ...
        this.send(request, clientParams).then(undefined, function() {
            return undefined;
        });
    };
    JSONRPCClient.prototype.send = function(payload, clientParams) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                return [
                    2 /*return*/ ,
                    this._send(payload, clientParams)
                ];
            });
        });
    };
...
"[project]/node_modules/json-rpc-2.0/dist/interfaces.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/json-rpc-2.0/dist/server.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
            ...
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        ...
                        if (!!(0, models_1.isJSONRPCRequest)(request)) return [
                            3 /*break*/ ,
                            1
                        ];
                        return [
                    ...
                    case 1:
                        return [
                            4 /*yield*/ ,
                            this.callMethod(method, request, serverParams)
                        ];
                    case 2:
                        response = _a.sent();
                        return [
...
"[project]/node_modules/json-rpc-2.0/dist/server-and-client.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
    ...
    JSONRPCServerAndClient.prototype.receiveAndSend = function(payload, serverParams, clientParams) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        if (!((0, models_1.isJSONRPCResponse)(payload) || (0, models_1.isJSONRPCResponses)(payload))) return [
                            3 /*break*/ ,
                            1
                        ];
                    ...
                    case 1:
                        if (!((0, models_1.isJSONRPCRequest)(payload) || (0, models_1.isJSONRPCRequests)(payload))) return [
                            3 /*break*/ ,
                            3
                        ];
                        return [
                            4 /*yield*/ ,
                            this.server.receive(payload, serverParams)
                        ];
                    case 2:
                        response = _a.sent();
                        if (response) {
                            return [
                                2 /*return*/ ,
                                this.client.send(response, clientParams)
                            ];
                        }
                        return [
                            3 /*break*/ ,
...
"[project]/node_modules/json-rpc-2.0/dist/index.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
__exportStar(__turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/client.js [app-ssr] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/interfaces.js [app-ssr] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/models.js [app-ssr] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/server.js [app-ssr] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/json-rpc-2.0/dist/server-and-client.js [app-ssr] (ecmascript)"), exports);
}}),
...
"[project]/node_modules/@lukso/up-provider/dist/index.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "createClientUPProvider": (()=>createClientUPProvider),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$rpc$2d$2$2e$0$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/json-rpc-2.0/dist/index.js [app-ssr] (ecmascript)");
...
;
;
// src/UniversalProfiles_Apps_Logo_96px.svg.ts
...
;
var ModalPopup = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lit$2d$element$2f$development$2f$lit$2d$element$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["LitElement"] {
    constructor(){
        super(...arguments);
        this.isOpen = false;
        this.iframeSrc = "";
...
ModalPopup.styles = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lit$2f$reactive$2d$element$2f$node$2f$development$2f$css$2d$tag$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["css"]`
    .modal {
      display: none;
      position: fixed;
      top: 0;
...
// src/client.ts
var clientLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("upProvider:client");
var pendingRequests = /* @__PURE__ */ new Map();
var _options, _buffered;
var _UPClientProvider = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventemitter3$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"] {
    constructor(options){
        super();
    ...
    emit(event, ...args) {
        if (__privateGet(this, _buffered)) {
            __privateGet(this, _buffered).push([
                event,
                args
            ]);
            return false;
...
async function testWindow(up, remote, options) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        _up.postMessage("upProvider:hasProvider", "*", [
            channel.port2
        ]);
        timeout = setTimeout(()=>{
            timeout = 0;
...
function createClientUPProvider(authURL, search = true) {
    ...
    let searchPromise;
    const providerInfo = {
        uuid: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])(),
                ...
                try {
                    ...
                    switch(response.method){
                        ...
                        case "contextAccountsChanged":
                            ...
                            up.emit("contextAccountsChanged", // Cleanup wrong null or undefined.
                            cleanupAccounts(contextAccounts));
                            return;
                        case "accountsChanged":
                            allowedAccounts = response.params;
                            up.emit("accountsChanged", // Cleanup wrong null or undefined.
    ...
    const allocateConnection = async ()=>{
        const client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$rpc$2d$2$2e$0$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["JSONRPCClient"](async (jsonRPCRequest)=>{
            ...
            switch(method){
                case "eth_call":
                    if (rpcUrls.length > 0 && Object.keys(params?.[0] ?? {}).every((key)=>!/^gasPrice|maxFeePerGas|maxPriorityFeePerGas|value$/.test(key))) {
                        ...
                        const err = new Error(`All RPC URLs failed: ${errors.map((e)=>e.message).join(", ")}`);
                        err.errors = errors;
                        throw err;
                    }
            }
...
;
;
var serverLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("upProvider:server");
var _accounts, _contextAccounts, _chainId, _rpcUrls, _buffered2, _serverChannel, _server, _getter, _setter;
var _UPClientChannel = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventemitter3$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"] {
    ...
    emit(event, ...args) {
        if (__privateGet(this, _buffered2)) {
            __privateGet(this, _buffered2).push([
                event,
                args
            ]);
            return false;
    ...
    resume(delay = 0) {
        const buffered = __privateGet(this, _buffered2);
        if (!buffered) {
            return;
        }
        __privateSet(this, _buffered2, void 0);
        setTimeout(()=>{
            while(buffered.length > 0){
                const val = buffered.shift();
                if (val) {
    ...
    async setAllowedAccounts(accounts) {
        ...
        if (accountsChanged) {
            ...
            if (__privateGet(this, _getter).call(this)) {
                await this.send("accountsChanged", cleanupAccounts([
                    ...__privateGet(this, _accounts)
                ]));
    ...
    async setContextAccounts(contextAccounts) {
        ...
        if (accountsChanged) {
            ...
            __privateSet(this, _contextAccounts, [
                ...contextAccounts
            ]);
            await this.send("contextAccountsChanged", cleanupAccounts([
                ...__privateGet(this, _contextAccounts)
            ]));
        }
    }
    get contextAccounts() {
    ...
    async setupChannel(enable, accounts, contextAccounts, chainId) {
        ...
        if (sendAccountsChanged) {
            await this.send("accountsChanged", cleanupAccounts(__privateGet(this, _getter).call(this) ? [
                ...__privateGet(this, _accounts)
            ] : []));
            this.emit(__privateGet(this, _getter).call(this) && __privateGet(this, _accounts).length > 0 ? "connected" : "disconnected");
        }
    ...
    async setEnable(value) {
        if (value !== this.enable) {
            ...
            this.send("accountsChanged", cleanupAccounts(__privateGet(this, _getter).call(this) ? [
                ...__privateGet(this, _accounts)
            ] : []));
            this.emit(__privateGet(this, _getter).call(this) && __privateGet(this, _accounts).length > 0 ? "connected" : "disconnected");
        }
...
_getter = new WeakMap();
_setter = new WeakMap();
var _options2, _channels;
var _UPProviderConnector = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventemitter3$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"] {
    ...
    async setAllowedAccounts(accounts) {
        ...
        if (allowedAccountsChanged) {
            this._getOptions().allowedAccounts = [
                ...accounts
            ];
   ...
   */ async setContextAccounts(contextAccounts) {
        ...
        if (contextAccountsChanged) {
            this._getOptions().contextAccounts = [
                ...contextAccounts
            ];
            for (const item of this.channels.values()){
        ...
        this._getOptions().promise = new Promise((resolve, reject)=>{
            ...
            (async ()=>{
                try {
                    ...
                    const newRpcUrls = Array.isArray(rpcUrls) ? rpcUrls : [
                        rpcUrls
                    ];
...
function createUPProviderConnector(provider, rpcUrls) {
    ...
    const options = {
        ...
        rpcUrls: Array.isArray(rpcUrls) ? rpcUrls : rpcUrls != null ? [
            rpcUrls
        ] : [],
        chainId: 0,
        allowedAccounts: [],
    ...
    options.providerHandler = (event)=>{
        if (event.data === "upProvider:hasProvider") {
            ...
            const server = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$rpc$2d$2$2e$0$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["JSONRPCServer"]();
            let enabled = false;
            if (previous) {
                channelId = previous.id;
            } else {
                channelId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
            }
            const channel_ = new _UPClientChannel(serverChannel, event.source, iframe, channelId, server, ()=>enabled, (value)=>{
                enabled = value;
            });
            server.applyMiddleware(async (next, request)=>{
                ...
                switch(method){
                    ...
                    case "accounts":
                        {
                            const accounts = cleanupAccounts(enabled ? [
                                ...channel_.allowedAccounts
                            ] : []);
                            serverLog("short circuit response", request);
...
//# sourceMappingURL=node_modules_5a9c36e2._.js.map